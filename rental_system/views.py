"""
RENTAL SYSTEM VIEWS.PY - V13
=============================

RENDER DEPLOYMENT + WORDPRESS INTEGRATION
VERSIE: 13 - RENDER DEPLOYMENT READY

ALL CRITICAL ISSUES SOLVED:
- ✅ LOGIN STATUS: Fixed user_info context for template
...
- ✅ All version strings consistency (V13 throughout)

ALL API ENDPOINTS V13 READY:
- api_health, api_formulas, api_debug_formulas, api_availability
- api_calculate_price, api_create_reservation
- api_status, api_info, api_wordpress_test, api_wordpress_urls
- api_login, api_logout, api_register, api_user_session
...
wp_status = {'success': False, 'message': 'Skipped for performance'}
        ...
        # Add WordPress test URL for reference
        ngrok_url = "https://roentgenologic-cormous-oscar.ngrok-free.dev"
        ...
        logger.info(f"V13 calendar view loaded - WordPress: {wordpress_status}")
...
# Fallback views for other endpoints
@csrf_exempt
@require_http_methods(["GET"])
